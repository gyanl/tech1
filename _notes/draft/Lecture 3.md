...
- **Exercise:** [[Exercise - Trace a Request]] — use the Network tab to watch your own site load, piece by piece
- Reading a URL like a sentence: protocol, domain, path, query string
