...
#### Hour 2 — Studio
- **Exercise:** [[Exercise - API Mashup]] — use AI to build a small page powered by a public API (weather, movies, maps, transit)
- JSON literacy: reading the response with your own eyes
